...
import jio.System.Windows.Data.*;public class StringToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public StringToVisibilityConverter (){ try {  javonetHandle = Javonet.New("StringToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public StringToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
