...
import jio.System.Windows.Data.*;public class EmptyStringToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public EmptyStringToVisibilityConverter (){ try {  javonetHandle = Javonet.New("EmptyStringToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public EmptyStringToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
