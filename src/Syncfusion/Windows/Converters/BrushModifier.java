...
import jio.System.Windows.Data.*;public class BrushModifier implements IValueConverter {protected NObject javonetHandle; public BrushModifier (){ try {  javonetHandle = Javonet.New("BrushModifier");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BrushModifier(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
