...
import jio.System.Windows.Data.*;public class InverseBooleanToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public InverseBooleanToVisibilityConverter (){ try {  javonetHandle = Javonet.New("InverseBooleanToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public InverseBooleanToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
