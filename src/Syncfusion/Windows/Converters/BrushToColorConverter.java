...
import jio.System.Windows.Data.*;public class BrushToColorConverter implements IValueConverter {protected NObject javonetHandle; public BrushToColorConverter (){ try {  javonetHandle = Javonet.New("BrushToColorConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BrushToColorConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
