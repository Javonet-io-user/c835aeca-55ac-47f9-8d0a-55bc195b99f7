...
import jio.System.Windows.Data.*;public class DoubleToThicknessConverter implements IValueConverter {protected NObject javonetHandle; public DoubleToThicknessConverter (){ try {  javonetHandle = Javonet.New("DoubleToThicknessConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DoubleToThicknessConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
