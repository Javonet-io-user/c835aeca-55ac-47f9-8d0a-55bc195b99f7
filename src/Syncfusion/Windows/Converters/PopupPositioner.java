...
import jio.System.Windows.Data.*;public class PopupPositioner implements IValueConverter {protected NObject javonetHandle; public PopupPositioner (){ try {  javonetHandle = Javonet.New("PopupPositioner");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public PopupPositioner(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
