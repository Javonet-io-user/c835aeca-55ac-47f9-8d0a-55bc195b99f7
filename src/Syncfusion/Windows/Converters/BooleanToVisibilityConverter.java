...
import jio.System.Windows.Data.*;public class BooleanToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public BooleanToVisibilityConverter (){ try {  javonetHandle = Javonet.New("BooleanToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public BooleanToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
