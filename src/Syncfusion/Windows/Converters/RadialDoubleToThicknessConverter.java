...
import jio.System.Windows.Data.*;public class RadialDoubleToThicknessConverter implements IValueConverter {protected NObject javonetHandle; public RadialDoubleToThicknessConverter (){ try {  javonetHandle = Javonet.New("RadialDoubleToThicknessConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public RadialDoubleToThicknessConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
