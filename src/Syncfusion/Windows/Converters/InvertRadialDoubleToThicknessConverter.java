...
import jio.System.Windows.Data.*;public class InvertRadialDoubleToThicknessConverter implements IValueConverter {protected NObject javonetHandle; public InvertRadialDoubleToThicknessConverter (){ try {  javonetHandle = Javonet.New("InvertRadialDoubleToThicknessConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public InvertRadialDoubleToThicknessConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
