...
import jio.System.Windows.Data.*;public class PrecisionToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public PrecisionToVisibilityConverter (){ try {  javonetHandle = Javonet.New("PrecisionToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public PrecisionToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
