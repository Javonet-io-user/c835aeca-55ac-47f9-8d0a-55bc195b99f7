...
import jio.System.Windows.Data.*;public class RandomBrushConverter implements IValueConverter {protected NObject javonetHandle; public RandomBrushConverter (){ try {  javonetHandle = Javonet.New("RandomBrushConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public RandomBrushConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
