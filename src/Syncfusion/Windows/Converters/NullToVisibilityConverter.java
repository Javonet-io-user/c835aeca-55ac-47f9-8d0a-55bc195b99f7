...
import jio.System.Windows.Data.*;public class NullToVisibilityConverter implements IValueConverter {protected NObject javonetHandle; public NullToVisibilityConverter (){ try {  javonetHandle = Javonet.New("NullToVisibilityConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public NullToVisibilityConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
