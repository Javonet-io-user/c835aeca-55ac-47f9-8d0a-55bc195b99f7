...
import jio.System.Windows.Data.*;public class RGBConverter implements IValueConverter {protected NObject javonetHandle; public RGBConverter (){ try {  javonetHandle = Javonet.New("RGBConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public RGBConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
