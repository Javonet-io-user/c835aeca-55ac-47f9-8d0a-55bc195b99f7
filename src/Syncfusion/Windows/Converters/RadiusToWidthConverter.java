...
import jio.System.Windows.Data.*;public class RadiusToWidthConverter implements IValueConverter {protected NObject javonetHandle; public RadiusToWidthConverter (){ try {  javonetHandle = Javonet.New("RadiusToWidthConverter");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public RadiusToWidthConverter(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
