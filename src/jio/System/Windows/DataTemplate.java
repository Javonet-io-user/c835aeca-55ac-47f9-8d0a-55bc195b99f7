...
import jio.System.*;public class DataTemplate {public NObject javonetHandle; public DataTemplate (){ try {  javonetHandle = Javonet.New("DataTemplate");} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); } }public DataTemplate(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
